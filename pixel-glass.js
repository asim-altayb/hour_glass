var createPixelGlass = function(){
  ...
  var HourGlass = function(config){
    ...
    this.canvas= document.getElementById("hourglass");
...
start.onclick=function (){
  var min=document.getElementById("seconds").value;

  var glass = createPixelGlass();
    document.body.appendChild(glass.getCanvas());
    glass.start(min,function(){console.log("ok");});
    countdown(min);
}
